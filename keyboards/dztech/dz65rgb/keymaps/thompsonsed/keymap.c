...
enum custom_keycodes{
	ASSIGN_SHORTCUT = SAFE_RANGE,
};

bool process_record_user(uint16_t keycode, keyrecord_t *record) {
	switch(keycode){
		case ASSIGN_SHORTCUT:
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi(
        ...
        KC_LSFT,                 KC_NUHS, _______, _______, _______, _______, NK_TOGG, _______, ASSIGN_SHORTCUT, _______, _______, _______, KC_VOLU,   KC_MUTE,
